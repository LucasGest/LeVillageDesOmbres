...
// --- Liste des rôles ---
const roles = [
  { code: "CUP", nom: "Cupidon", description: "Au début de la partie, Cupidon désigne deux joueurs amoureux.", image: "img/cupidon.png" },
  { code: "SOR", nom: "Sorcière", description: "Elle possède deux potions : une pour sauver, une pour tuer.", image: "img/soso.png" },
  { code: "VOY", nom: "Voyante", description: "Chaque nuit, elle découvre l’identité d’un joueur.", image: "img/vovo.png" },
  { code: "PF", nom: "Petite Fille", description: "Elle espionne les loups la nuit, discrètement.", image: "img/pf.png" },
  { code: "SV", nom: "Simple Villageois", description: "Il n’a aucun pouvoir spécial.", image: "img/villageois.png" },
  { code: "LG", nom: "Loup Garou", description: "Chaque nuit, ils dévorent un joueur.", image: "img/lg.png" }
];
